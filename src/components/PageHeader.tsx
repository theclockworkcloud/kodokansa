  ...
  return (
    <div className="kodo-page-header py-20 sm:py-24">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <h1 className="hero-enter hero-enter-1 font-serif text-4xl font-light tracking-tight text-kodo-white sm:text-5xl lg:text-6xl">
          {title}
        </h1>
        <p className="hero-enter hero-enter-2 mt-4 max-w-2xl text-lg text-kodo-gray-300">
          {subtitle}
        </p>
      </div>
